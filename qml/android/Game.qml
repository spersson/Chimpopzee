...
//	SoundEffect { id: plopper; source: "qrc:///sounds/plopp" }
	...
	ParticleSystem {
		...
		Emitter {
			...
			velocity: AngleDirection {
				angleVariation: 180
				magnitude: 300; magnitudeVariation: 100
			}
			emitRate: 0
		}
		...
		Emitter {
			...
			velocity: AngleDirection {
				magnitude: 200; magnitudeVariation: 100
	...
	function splash(coords) {
		splasher.burst(15, coords.x, coords.y);
	}

	function starBurst(coords) {
